...
const CACHE_NAME = 'absensi-edip-cache-v1';

// Daftar semua file dan aset yang perlu disimpan untuk mode offline
const urlsToCache = [
...
// Event 'fetch': Dijalankan setiap kali aplikasi meminta sumber daya (misal: gambar, skrip)
...
// Event 'activate': Dijalankan untuk membersihkan cache lama jika ada versi baru
